...
export default function AdminParticipaciones() {
  ...
  // URL dinámica de exportación CSV con todos los filtros activos aplicados
  const getExportUrl = () => {
    let params = new URLSearchParams();
    if (filtroCuenta.trim() && filtroCuenta !== 'TODOS') {
      params.append('numero_cuenta', filtroCuenta.trim());
    }
    if (filtroFecha) {
  ...
  return (
    <div className="card shadow-sm border-0 p-4">
      ...
      <p className="text-muted small">
        Filtra los registros por número de cuenta o fecha para depurar entregas de la sesión o exportar reportes.
      </p>
