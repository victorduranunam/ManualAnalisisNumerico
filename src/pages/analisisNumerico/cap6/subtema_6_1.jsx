...
import FundamentosTab from "./subtema_6_1_components/FundamentosTab";
import VideosTab from "./subtema_6_1_components/VideosTab";
import SimuladorTab from "./subtema_6_1_components/SimuladorTab";
import EjerciciosTab from "./subtema_6_1_components/EjerciciosTab";
import CuestionarioTab from "./subtema_6_1_components/CuestionarioTab";

export const Subtema6_1 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">
          3.1 Importancia de los métodos numéricos en Ingeniería
        </h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-6-1-tabs" defaultActiveKey="fundamentos">
