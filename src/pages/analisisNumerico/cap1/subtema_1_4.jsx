  ...
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">1.4 - Criterios fundamentales en métodos numéricos: precisión, estabilidad y convergencia</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-1-4-tabs" defaultActiveKey="fundamentos">
