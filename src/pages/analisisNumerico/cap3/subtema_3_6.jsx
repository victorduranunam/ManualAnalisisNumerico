...
import FundamentosTab from "./subtema_3_6_components/FundamentosTab";
import VideosTab from "./subtema_3_6_components/VideosTab";
import SimuladorTab from "./subtema_3_6_components/SimuladorTab";
import EjerciciosTab from "./subtema_3_6_components/EjerciciosTab";
import CuestionarioTab from "./subtema_3_6_components/CuestionarioTab";
...
const Subtema_3_6 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-3-6-tabs" defaultActiveKey="fundamentos">
