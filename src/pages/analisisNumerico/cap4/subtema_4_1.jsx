...
import FundamentosTab from "./subtema_4_1_components/FundamentosTab";
import VideosTab from "./subtema_4_1_components/VideosTab";
import SimuladorTab from "./subtema_4_1_components/SimuladorTab";
import EjerciciosTab from "./subtema_4_1_components/EjerciciosTab";
import CuestionarioTab from "./subtema_4_1_components/CuestionarioTab";

export const Subtema4_1 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-4-1-tabs" defaultActiveKey="fundamentos">
