      ...
      <div className="d-block d-md-none mb-3">
        <div className="card shadow-sm border-0">
          <div className="card-body p-3">
            ...
            >
              <option value="cap4">📋 Vista General del Capítulo</option>
              {subtemas.map((st) => (
      ...
      <div className="row g-4">
          ...
          <div className="card border-0 shadow-sm overflow-hidden sticky-top" style={{ top: "80px" }}>
            <div className="card-header bg-unam text-white p-3">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="badge bg-warning text-dark">Cap&iacute;tulo 4</span>
              </div>
        ...
        <div className="col-md-9">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            {activeSection === 'cap4' && (
              <div>
                <span className="badge bg-primary mb-2">Capítulo 4</span>
                <h2 className="fw-bold text-dark"> Interpolación, derivación e integración numéricas </h2>
...
Aplicar métodos numéricos para interpolar, derivar e integrar funciones definidas por datos discretos,
utilizando herramientas computacionales para obtener soluciones con la precisión deseada en problemas de ingeniería.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6">
            ...
            {activeSection !== 'cap4' && !['subtema_4_1', 'subtema_4_2', 'subtema_4_3', 'subtema_4_4', 'subtema_4_5'].includes(activeSection) && (
