...
import FundamentosTab from "./subtema_5_1_components/FundamentosTab";
import VideosTab from "./subtema_5_1_components/VideosTab";
import SimuladorTab from "./subtema_5_1_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_1_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_1_components/CuestionarioTab";

export const Subtema5_1 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-5-1-tabs" defaultActiveKey="fundamentos">
