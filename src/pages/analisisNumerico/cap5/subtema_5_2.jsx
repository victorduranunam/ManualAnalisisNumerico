...
import FundamentosTab from "./subtema_5_2_components/FundamentosTab";
import VideosTab from "./subtema_5_2_components/VideosTab";
import SimuladorTab from "./subtema_5_2_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_2_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_2_components/CuestionarioTab";

export const Subtema5_2 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-5-2-tabs" defaultActiveKey="fundamentos">
