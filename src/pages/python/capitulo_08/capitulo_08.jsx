...
const CapituloPython_8 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 8: Visualización con Matplotlib</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-8-tabs" defaultActiveKey="fundamentos">
...
export default CapituloPython_8;