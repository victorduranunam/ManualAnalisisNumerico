...
import FundamentosTab from "./subtema_9_6_components/FundamentosTab";
import VideosTab from "./subtema_9_6_components/VideosTab";
import SimuladorTab from "./subtema_9_6_components/SimuladorTab";
import EjerciciosTab from "./subtema_9_6_components/EjerciciosTab";
import CuestionarioTab from "./subtema_9_6_components/CuestionarioTab";

const subtema_9_6 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">9.6 - Ecuaciones Diferenciales</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-9-6-tabs" defaultActiveKey="fundamentos">
