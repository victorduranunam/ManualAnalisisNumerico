...
import FundamentosTab from "./subtema_9_7_components/FundamentosTab";
import VideosTab from "./subtema_9_7_components/VideosTab";
import SimuladorTab from "./subtema_9_7_components/SimuladorTab";
import EjerciciosTab from "./subtema_9_7_components/EjerciciosTab";
import CuestionarioTab from "./subtema_9_7_components/CuestionarioTab";
...
const subtema_9_7 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-9-7-tabs" defaultActiveKey="fundamentos">
