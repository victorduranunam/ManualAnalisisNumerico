...
export const Index = ({ activeSection, onSelectSection }) => {
  ...
  const subtemas = [
    { id: 'py_9_1', num: '9.1', title: '9.1 Introducción a Python y su uso en el Análisis Numérico' },
    { id: 'py_9_2', num: '9.2', title: '9.2 Principios del desarrollo de programas en Python' },
    { id: 'py_9_3', num: '9.3', title: '9.3 Aplicación en el Análisis Numérico' },
  ];
      ...
      <div className="d-block d-md-none mb-3">
        <div className="card shadow-sm border-0">
          <div className="card-body p-3">
            ...
            >
              <option value="py_cap9">📋 Vista General del Módulo</option>
              {subtemas.map((st) => (
      ...
      <div className="row g-4">
          ...
          <div className="card border-0 shadow-sm overflow-hidden sticky-top" style={{ top: "80px" }}>
            <div className="card-header bg-dark text-white p-3">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="badge bg-warning text-dark">Módulo 9</span>
              </div>
            </div>
            ...
            <div className="list-group list-group-flush">
              ...
              <button
                onClick={() => onSelectSection('py_cap9')}
                className={`list-group-item list-group-item-action py-2 small text-start ${
                  activeSection === 'py_cap9' ? 'active fw-bold bg-dark border-dark' : 'text-secondary'
                }`}
              >
        ...
        <div className="col-md-9">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            {/* 1. VISTA GENERAL DE PYTHON CAPÍTULO 9 */}
            {activeSection === 'py_cap9' && (
              <div>
                <span className="badge bg-success mb-2">Introducción a Python</span>
                <h2 className="fw-bold text-dark">Capítulo 9: Fundamentos de Python</h2>
