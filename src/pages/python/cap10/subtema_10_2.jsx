...
import FundamentosTab from "./subtema_10_2_components/FundamentosTab";
import VideosTab from "./subtema_10_2_components/VideosTab";
import SimuladorTab from "./subtema_10_2_components/SimuladorTab";
import EjerciciosTab from "./subtema_10_2_components/EjerciciosTab";
import CuestionarioTab from "./subtema_10_2_components/CuestionarioTab";

const Subtema_10_2 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">10.2 - Ecuaciones Diferenciales</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-10-2-tabs" defaultActiveKey="fundamentos">
