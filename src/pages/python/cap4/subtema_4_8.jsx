...
import FundamentosTab from "./subtema_4_8_components/FundamentosTab";
import VideosTab from "./subtema_4_8_components/VideosTab";
import SimuladorTab from "./subtema_4_8_components/SimuladorTab";
import EjerciciosTab from "./subtema_4_8_components/EjerciciosTab";
import CuestionarioTab from "./subtema_4_8_components/CuestionarioTab";
...
const Subtema_4_8 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-4-8-tabs" defaultActiveKey="fundamentos">
