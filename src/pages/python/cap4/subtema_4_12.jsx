...
import FundamentosTab from "./subtema_4_12_components/FundamentosTab";
import VideosTab from "./subtema_4_12_components/VideosTab";
import SimuladorTab from "./subtema_4_12_components/SimuladorTab";
import EjerciciosTab from "./subtema_4_12_components/EjerciciosTab";
import CuestionarioTab from "./subtema_4_12_components/CuestionarioTab";

const Subtema_4_12 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">4.12 - Creación de arreglos inicializados</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-4-12-tabs" defaultActiveKey="fundamentos">
