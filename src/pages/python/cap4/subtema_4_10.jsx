...
import FundamentosTab from "./subtema_4_10_components/FundamentosTab";
import VideosTab from "./subtema_4_10_components/VideosTab";
import SimuladorTab from "./subtema_4_10_components/SimuladorTab";
import EjerciciosTab from "./subtema_4_10_components/EjerciciosTab";
import CuestionarioTab from "./subtema_4_10_components/CuestionarioTab";

const Subtema_4_10 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">4.8 - Interpolación y Ajuste</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-4-10-tabs" defaultActiveKey="fundamentos">
