...
import FundamentosTab from "./subtema_4_5_components/FundamentosTab";
import VideosTab from "./subtema_4_5_components/VideosTab";
import SimuladorTab from "./subtema_4_5_components/SimuladorTab";
import EjerciciosTab from "./subtema_4_5_components/EjerciciosTab";
import CuestionarioTab from "./subtema_4_5_components/CuestionarioTab";

const Subtema_4_5 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">4.5 - Interpolación y Ajuste</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-4-5-tabs" defaultActiveKey="fundamentos">
