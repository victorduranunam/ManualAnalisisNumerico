...
import FundamentosTab from "./subtema_1_8_components/FundamentosTab";
import VideosTab from "./subtema_1_8_components/VideosTab";
import SimuladorTab from "./subtema_1_8_components/SimuladorTab";
import EjerciciosTab from "./subtema_1_8_components/EjerciciosTab";
import CuestionarioTab from "./subtema_1_8_components/CuestionarioTab";

const Subtema_1_8 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">1.8 - Teoría de Errores</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-1-8-tabs" defaultActiveKey="fundamentos">
