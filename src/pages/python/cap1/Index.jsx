...
export const Index = ({ activeSection, onSelectSection }) => {
  ...
  const subtemas = [
    { id: 'py_1_1', num: '1.1', title: '1.1 Introducción a Python y su uso en el Análisis Numérico' },
    { id: 'py_1_2', num: '1.2', title: '1.2 Principios del desarrollo de programas en Python' },
    { id: 'py_1_3', num: '1.3', title: '1.3 Aplicación en el Análisis Numérico' },
  ];
      ...
      <div className="d-block d-md-none mb-3">
        <div className="card shadow-sm border-0">
          <div className="card-body p-3">
            ...
            >
              <option value="py_cap1">📋 Vista General del Módulo</option>
              {subtemas.map((st) => (
      ...
      <div className="row g-4">
        ...
        <div className="col-md-3 d-none d-md-block">
          <div className="card border-0 shadow-sm overflow-hidden sticky-top" style={{ top: "80px" }}>
            ...
            <div className="list-group list-group-flush">
              ...
              <button
                onClick={() => onSelectSection('py_cap1')}
                className={`list-group-item list-group-item-action py-2 small text-start ${
                  activeSection === 'py_cap1' ? 'active fw-bold bg-dark border-dark' : 'text-secondary'
                }`}
              >
        ...
        <div className="col-md-9">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            {/* 1. VISTA GENERAL DE PYTHON CAPÍTULO 1 */}
            {activeSection === 'py_cap1' && (
              <div>
