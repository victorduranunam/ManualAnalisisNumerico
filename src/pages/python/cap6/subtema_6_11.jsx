...
import FundamentosTab from "./subtema_6_11_components/FundamentosTab";
import VideosTab from "./subtema_6_11_components/VideosTab";
import SimuladorTab from "./subtema_6_11_components/SimuladorTab";
import EjerciciosTab from "./subtema_6_11_components/EjerciciosTab";
import CuestionarioTab from "./subtema_6_11_components/CuestionarioTab";

const Subtema_6_11 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">6.11 - Función enumerate()</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-6-11-tabs" defaultActiveKey="fundamentos">
