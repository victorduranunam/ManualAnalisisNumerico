...
import FundamentosTab from "./subtema_6_13_components/FundamentosTab";
import VideosTab from "./subtema_6_13_components/VideosTab";
import SimuladorTab from "./subtema_6_13_components/SimuladorTab";
import EjerciciosTab from "./subtema_6_13_components/EjerciciosTab";
import CuestionarioTab from "./subtema_6_13_components/CuestionarioTab";

const Subtema_6_13 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">6.13 - Uso de break y continue</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-6-13-tabs" defaultActiveKey="fundamentos">
