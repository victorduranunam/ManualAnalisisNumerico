...
import FundamentosTab from "./subtema_6_9_components/FundamentosTab";
import VideosTab from "./subtema_6_9_components/VideosTab";
import SimuladorTab from "./subtema_6_9_components/SimuladorTab";
import EjerciciosTab from "./subtema_6_9_components/EjerciciosTab";
import CuestionarioTab from "./subtema_6_9_components/CuestionarioTab";

const Subtema_6_9 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">6.9 - Recorrido de listas, cadenas y arreglos con FOR</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-6-9-tabs" defaultActiveKey="fundamentos">
