...
import FundamentosTab from './capitulo_01_components/FundamentosTab';
import VideosTab from './capitulo_01_components/VideosTab';
import SimuladorTab from './capitulo_01_components/SimuladorTab';
import EjerciciosTab from './capitulo_01_components/EjerciciosTab';
import CuestionarioTab from './capitulo_01_components/CuestionarioTab';

const CapituloPython_1 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 1: Fundamentos y sintaxis</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-1-tabs" defaultActiveKey="fundamentos">
