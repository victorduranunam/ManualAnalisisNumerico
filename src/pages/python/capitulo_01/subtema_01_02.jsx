...
import FundamentosTab from './subtema_01_02_components/FundamentosTab';
import VideosTab from './subtema_01_02_components/VideosTab';
import SimuladorTab from './subtema_01_02_components/SimuladorTab';
import EjerciciosTab from './subtema_01_02_components/EjerciciosTab';
import CuestionarioTab from './subtema_01_02_components/CuestionarioTab';

const SubtemaPython_1_2 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-secondary text-white">
      <h5 className="mb-0">Subtema 1.2 - Principios del desarrollo en Python</h5>
    </Card.Header>
    <Card.Body>
