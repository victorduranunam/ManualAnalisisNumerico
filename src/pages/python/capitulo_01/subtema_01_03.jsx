...
import FundamentosTab from './subtema_01_03_components/FundamentosTab';
import VideosTab from './subtema_01_03_components/VideosTab';
import SimuladorTab from './subtema_01_03_components/SimuladorTab';
import EjerciciosTab from './subtema_01_03_components/EjerciciosTab';
import CuestionarioTab from './subtema_01_03_components/CuestionarioTab';

const SubtemaPython_1_3 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-secondary text-white">
      <h5 className="mb-0">Subtema 1.3 - Aplicación en Análisis Numérico</h5>
    </Card.Header>
    <Card.Body>
