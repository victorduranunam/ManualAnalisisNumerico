...
import FundamentosTab from "./subtema_7_7_components/FundamentosTab";
import VideosTab from "./subtema_7_7_components/VideosTab";
import SimuladorTab from "./subtema_7_7_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_7_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_7_components/CuestionarioTab";

const Subtema_7_7 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.7 - Funciones aplicadas al análisis numérico</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-7-tabs" defaultActiveKey="fundamentos">
