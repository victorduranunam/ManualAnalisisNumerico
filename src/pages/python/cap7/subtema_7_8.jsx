...
import FundamentosTab from "./subtema_7_8_components/FundamentosTab";
import VideosTab from "./subtema_7_8_components/VideosTab";
import SimuladorTab from "./subtema_7_8_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_8_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_8_components/CuestionarioTab";

const Subtema_7_8 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.8 - Funciones con arreglos NumPy</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-8-tabs" defaultActiveKey="fundamentos">
