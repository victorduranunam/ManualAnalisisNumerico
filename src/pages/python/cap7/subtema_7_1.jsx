...
import FundamentosTab from "./subtema_7_1_components/FundamentosTab";
import VideosTab from "./subtema_7_1_components/VideosTab";
import SimuladorTab from "./subtema_7_1_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_1_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_1_components/CuestionarioTab";

const Subtema_7_1 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.1 - Ecuaciones Diferenciales</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-1-tabs" defaultActiveKey="fundamentos">
