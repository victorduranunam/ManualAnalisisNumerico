...
import FundamentosTab from "./subtema_7_4_components/FundamentosTab";
import VideosTab from "./subtema_7_4_components/VideosTab";
import SimuladorTab from "./subtema_7_4_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_4_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_4_components/CuestionarioTab";

const Subtema_7_4 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.4 - Creación de funciones propias (def)</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-4-tabs" defaultActiveKey="fundamentos">
