...
export const Index = ({ activeSection, onSelectSection }) => {
  ...
  const subtemas = [
    { id: 'py_7_1', num: '7.1', title: '7.1 Introducción a Python y su uso en el Análisis Numérico' },
    { id: 'py_7_2', num: '7.2', title: '7.2 Principios del desarrollo de programas en Python' },
    { id: 'py_7_3', num: '7.3', title: '7.3 Aplicación en el Análisis Numérico' },
  ];
      ...
      <div className="row g-4">
        ...
        <div className="col-md-3 d-none d-md-block">
          <div className="card border-0 shadow-sm overflow-hidden sticky-top" style={{ top: "80px" }}>
            ...
            <div className="list-group list-group-flush">
              ...
              <button
                onClick={() => onSelectSection('py_cap7')}
                className={`list-group-item list-group-item-action py-2 small text-start ${
                  activeSection === 'py_cap7' ? 'active fw-bold bg-dark border-dark' : 'text-secondary'
                }`}
              >
        ...
        <div className="col-md-9">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            {/* 1. VISTA GENERAL DE PYTHON CAPÍTULO 7 */}
            {activeSection === 'py_cap7' && (
              <div>
                <span className="badge bg-success mb-2">Introducción a Python</span>
                <h2 className="fw-bold text-dark">Capítulo 7: Fundamentos de Python</h2>
