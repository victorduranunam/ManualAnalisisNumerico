...
import FundamentosTab from "./subtema_7_2_components/FundamentosTab";
import VideosTab from "./subtema_7_2_components/VideosTab";
import SimuladorTab from "./subtema_7_2_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_2_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_2_components/CuestionarioTab";

const Subtema_7_2 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.2 - Funciones incorporadas de Python (Built-in)</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-2-tabs" defaultActiveKey="fundamentos">
