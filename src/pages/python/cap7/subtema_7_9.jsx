...
import FundamentosTab from "./subtema_7_9_components/FundamentosTab";
import VideosTab from "./subtema_7_9_components/VideosTab";
import SimuladorTab from "./subtema_7_9_components/SimuladorTab";
import EjerciciosTab from "./subtema_7_9_components/EjerciciosTab";
import CuestionarioTab from "./subtema_7_9_components/CuestionarioTab";

const Subtema_7_9 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">7.9 - Organización y modularidad de programas</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-7-9-tabs" defaultActiveKey="fundamentos">
