...
const CapituloPython_5 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 5: Programación orientada a objetos</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-5-tabs" defaultActiveKey="fundamentos">
...
export default CapituloPython_5;