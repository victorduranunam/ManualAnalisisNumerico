...
import FundamentosTab from "./subtema_5_9_components/FundamentosTab";
import VideosTab from "./subtema_5_9_components/VideosTab";
import SimuladorTab from "./subtema_5_9_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_9_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_9_components/CuestionarioTab";

const Subtema_5_9 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">5.9 - Consulta de características de un arreglo</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-5-9-tabs" defaultActiveKey="fundamentos">
