...
import FundamentosTab from "./subtema_5_3_components/FundamentosTab";
import VideosTab from "./subtema_5_3_components/VideosTab";
import SimuladorTab from "./subtema_5_3_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_3_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_3_components/CuestionarioTab";

const Subtema_5_3 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">5.3 - Acceso a elementos de matrices</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-5-3-tabs" defaultActiveKey="fundamentos">
