...
import FundamentosTab from "./subtema_5_6_components/FundamentosTab";
import VideosTab from "./subtema_5_6_components/VideosTab";
import SimuladorTab from "./subtema_5_6_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_6_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_6_components/CuestionarioTab";
...
const Subtema_5_6 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      ...
      <Card.Body>
        <Tab.Container id="subtema-5-6-tabs" defaultActiveKey="fundamentos">
