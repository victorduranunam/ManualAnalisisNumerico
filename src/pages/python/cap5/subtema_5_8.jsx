...
import FundamentosTab from "./subtema_5_8_components/FundamentosTab";
import VideosTab from "./subtema_5_8_components/VideosTab";
import SimuladorTab from "./subtema_5_8_components/SimuladorTab";
import EjerciciosTab from "./subtema_5_8_components/EjerciciosTab";
import CuestionarioTab from "./subtema_5_8_components/CuestionarioTab";

const Subtema_5_8 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">5.8 - Copia de arreglos y referencias</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-5-8-tabs" defaultActiveKey="fundamentos">
