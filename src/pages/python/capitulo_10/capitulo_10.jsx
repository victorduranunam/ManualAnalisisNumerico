...
const CapituloPython_10 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 10: Proyecto final y buenas prácticas</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-10-tabs" defaultActiveKey="fundamentos">
...
export default CapituloPython_10;