...
export const Index = ({ activeSection, onSelectSection }) => {
  ...
  const subtemas = [
    { id: 'py_8_1', num: '8.1', title: '8.1 Introducción a Python y su uso en el Análisis Numérico' },
    { id: 'py_8_2', num: '8.2', title: '8.2 Principios del desarrollo de programas en Python' },
    { id: 'py_8_3', num: '8.3', title: '8.3 Aplicación en el Análisis Numérico' },
  ];
      ...
      <div className="d-block d-md-none mb-3">
        <div className="card shadow-sm border-0">
          <div className="card-body p-3">
            ...
            >
              <option value="py_cap8">📋 Vista General del Módulo</option>
              {subtemas.map((st) => (
      ...
      <div className="row g-4">
          ...
          <div className="card border-0 shadow-sm overflow-hidden sticky-top" style={{ top: "80px" }}>
            <div className="card-header bg-dark text-white p-3">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <span className="badge bg-warning text-dark">Módulo 8</span>
              </div>
            </div>
            ...
            <div className="list-group list-group-flush">
              ...
              <button
                onClick={() => onSelectSection('py_cap8')}
                className={`list-group-item list-group-item-action py-2 small text-start ${
                  activeSection === 'py_cap8' ? 'active fw-bold bg-dark border-dark' : 'text-secondary'
                }`}
              >
        ...
        <div className="col-md-9">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            {/* 1. VISTA GENERAL DE PYTHON CAPÍTULO 8 */}
            {activeSection === 'py_cap8' && (
              <div>
                <span className="badge bg-success mb-2">Introducción a Python</span>
                <h2 className="fw-bold text-dark">Capítulo 8: Fundamentos de Python</h2>
