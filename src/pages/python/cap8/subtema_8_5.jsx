...
import FundamentosTab from "./subtema_8_5_components/FundamentosTab";
import VideosTab from "./subtema_8_5_components/VideosTab";
import SimuladorTab from "./subtema_8_5_components/SimuladorTab";
import EjerciciosTab from "./subtema_8_5_components/EjerciciosTab";
import CuestionarioTab from "./subtema_8_5_components/CuestionarioTab";

const Subtema_8_5 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">8.5 - Ecuaciones Diferenciales</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-8-5-tabs" defaultActiveKey="fundamentos">
