...
import FundamentosTab from "./subtema_8_3_components/FundamentosTab";
import VideosTab from "./subtema_8_3_components/VideosTab";
import SimuladorTab from "./subtema_8_3_components/SimuladorTab";
import EjerciciosTab from "./subtema_8_3_components/EjerciciosTab";
import CuestionarioTab from "./subtema_8_3_components/CuestionarioTab";

const Subtema_8_3 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">8.3 - Ecuaciones Diferenciales</h4>
      </Card.Header>
