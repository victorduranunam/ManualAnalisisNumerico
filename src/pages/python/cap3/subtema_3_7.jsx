...
import FundamentosTab from "./subtema_3_7_components/FundamentosTab";
import VideosTab from "./subtema_3_7_components/VideosTab";
import SimuladorTab from "./subtema_3_7_components/SimuladorTab";
import EjerciciosTab from "./subtema_3_7_components/EjerciciosTab";
import CuestionarioTab from "./subtema_3_7_components/CuestionarioTab";

const Subtema_3_7 = () => {
  return (
    <Card className="shadow-sm border-0 mb-4">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0">3.7 -  Presentación de resultados</h4>
      </Card.Header>

      <Card.Body>
        <Tab.Container id="subtema-3-7-tabs" defaultActiveKey="fundamentos">
