...
const CapituloPython_6 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 6: NumPy y álgebra lineal</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-6-tabs" defaultActiveKey="fundamentos">
...
export default CapituloPython_6;