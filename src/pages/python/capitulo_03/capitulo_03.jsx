...
const CapituloPython_3 = () => (
  <Card className="shadow-sm border-0 mb-4">
    <Card.Header className="bg-success text-white">
      <h4 className="mb-0">Capítulo 3: Funciones y modularidad</h4>
    </Card.Header>
    <Card.Body>
      <Tab.Container id="python-capitulo-3-tabs" defaultActiveKey="fundamentos">
...
export default CapituloPython_3;